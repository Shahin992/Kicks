...
const HeroSection = () => {
  return (
    <section className="space-y-5 md:space-y-8">
      <h1 className="animate-fade-up text-center text-[52px] font-black uppercase leading-[0.95] tracking-tight text-[#232321] sm:text-[74px] md:text-[122px]">
        <span className="text-[#232321]">Do It </span>
        <span className="text-[#4a3ce2]">Right</span>
      </h1>

      <div className="animate-fade-up relative overflow-hidden rounded-[26px] border border-[#5b8ef4] bg-[#151515]">
        <img
          src={heroImage}
          alt="Nike Air Max"
          className="h-[360px] w-full object-cover transition-transform duration-500 hover:scale-[1.02] md:h-[700px]"
        />
        ...
        <div className="absolute bottom-4 right-4 z-10 hidden w-[130px] flex-col gap-3 md:bottom-10 md:right-10 md:flex md:w-[180px] md:gap-5">
          <div className="overflow-hidden rounded-2xl border border-white/70 bg-white/10 p-1 shadow-lg backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1">
